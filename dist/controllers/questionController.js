...
const addQuestions_1 = require("../Mapper/addQuestions");
let QuestionController = class QuestionController {
    constructor(_questionService) {
        this._questionService = _questionService;
        this.addquestions = async (req, res, next) => {
            try {
                const questionDto = await (0, addQuestions_1.questionMapper)(req.body);
...
exports.QuestionController = QuestionController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)('IQuestionService')),
